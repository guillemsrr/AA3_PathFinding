...
void TestScene::update(float dtime, SDL_Event *event)
{
...
const char* TestScene::getTitle()
{
	return "SDL Path Finding :: PathFinding Mouse Demo";
}

void TestScene::drawMaze()
{
...
void TestScene::initMaze(char* filename)
{
...
bool TestScene::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D TestScene::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D TestScene::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x / CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool TestScene::isValidCell(Vector2D cell)
{
